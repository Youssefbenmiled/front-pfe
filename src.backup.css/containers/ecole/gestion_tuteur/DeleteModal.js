          ...
          <ModalBody>
            ...
            {selectedItems.length === 1 &&
              <form onSubmit={this.handleSubmit}>
                ...
                <center>
                  <h2>
                    {tuteur && tuteur.eleves && tuteur.eleves.length > 1 ? <p>Enfants</p> : <p>Enfant</p>}
                  </h2>
                </center>
                <br></br>
                ...
                <br></br>
                <br></br>
                <Button type="submit" color="secondary" id="delsupp" onClick={toggleModal}>
                  Supprimer
                </Button>

                <Button color="danger" onClick={this.annuler} id="delann">
                  Annuler
                </Button>
