...
class ListPageHeading extends Component {
  ...
  render() {
    ...
    // console.log(selectedOrderMois, 'ssssssssssssssssssss')
            ...
            {niveau > -1 &&
              <div className="text-zero top-right-button-container">
                <Button
                  ...
                  onClick={toggleModal}
                >
                  <IntlMessages id="Créer une feuille d'appels" />
                </Button>
              ...
              <div className="d-block d-md-inline-block pt-1">
                <UncontrolledDropdown className="mr-1 float-md-left btn-group mb-1">
                  <DropdownToggle caret color="outline-dark" size="xs">
                    ...
                    Mois de : {selectedOrderMois.label}
                  </DropdownToggle>
                  <DropdownMenu>
                    {orderMois.map((order, index) => {
                      return (
                        <DropdownItem
                          key={index}
                          onClick={() => changeOrderMois(order.column)}
                        >
                          {order.label}
                        </DropdownItem>
                      );
