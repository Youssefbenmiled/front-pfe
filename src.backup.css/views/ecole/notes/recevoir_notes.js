...
import DataListView from "../../../containers/ecole/recevoir_notes/DataListView";
import Pagination from "../../../containers/ecole/recevoir_notes/Pagination";
import ListPageHeading from "../../../containers/ecole/recevoir_notes/ListPageHeading";
...
class recevoir_notes extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            emploi: [],
            valueType: { label: "TOUTES LES CLASSES", value: "*" },
            valueNiveau: {},
            valueClasse: {},
            items: [],
            modalOpenVoir: false
                ...
                <Fragment>
                    ...
                    {this.state.valueType.value == "*" ? (
                        <div className="disable-text-selection">
                            <ListPageHeading
                                heading="Historique des carnets de notes"
                    ...
                    {this.state.valueClasse.value != null &&
                        <div className="disable-text-selection">
                            <ListPageHeading
                                heading={"Liste des notes de la classe " + this.state.valueNiveau.value + "" + this.state.valueClasse.label}
                                displayMode={displayMode}
                                changeDisplayMode={this.changeDisplayMode}
                                handleChangeSelectAll={this.handleChangeSelectAll}
                                changeOrderBy={this.changeOrderBy}
