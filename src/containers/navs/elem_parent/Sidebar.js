...
class Sidebar extends Component {
    ...
    try {
      axios
        ...
        .then(data => {
          ...
          this.setState({ data, eleve: data.eleves.find(eleve => parseInt(eleve.id) === parseInt(localStorage.getItem('id_eleve'))) })
          this.verifData(data);
  ...
  verifData(tuteur) {
    ...
    if (tuteur.eleves.map(eleve => eleve.id).indexOf(parseInt(localStorage.getItem('id_eleve'))) === -1)
      return this.handleLogout();
                    ...
                    return (
                      ...
                      >
                        {item.newWindow ? (
                          ...
                          : item.id === 0 && eleve && eleve.classe ? (
                            <NavLink
                              to={item.to}
                              onClick={() => this.toggleModalVoir()}
                              data-flag={item.id}
                            >
                              <ModalEleve
                              ...
                              />
                              <i className={item.icon} />
                              <IntlMessages id={eleve.Nom + " " + eleve.prenom + " "} />
                            </NavLink>
                          )
                            : (
                              <NavLink
